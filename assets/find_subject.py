...
def detect_people_yolo(image_path, config_path, weights_path, coco_names_path, confidence_threshold=0.5, nms_threshold=0.4):
    ...
    # magick /Users/alessandro/Desktop/arduino/photos/photos/20220720_195729.jpg -auto-orient -resize 480x800^ /Users/alessandro/Desktop/arduino/photos/photos/20220720_195729_resized_1.jpg
    # identify -ping -format '%[EXIF:Orientation]x%wx%h' /Users/alessandro/Desktop/arduino/photos/photos/20220720_195729_resized_1.jpg
    # magick /Users/alessandro/Desktop/arduino/photos/photos/20220720_195729_resized_1.jpg -gravity center -crop 480x800+8-149 +repage /Users/alessandro/Desktop/arduino/photos/photos/20220720_195729_resized_2.jpg
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="yolov3.cfg", help="Path to YOLOv3 config file.")
    parser.add_argument("--weights", type=str, default="yolov3.weights", help="Path to YOLOv3 weights file.")
    parser.add_argument("--names", type=str, default="coco.names", help="Path to COCO names file.")
