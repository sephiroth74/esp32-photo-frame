...
ProcessorReport _$ProcessorReportFromJson(Map<String, dynamic> json) =>
    ProcessorReport(
      config: ProcessorConfig.fromJson(json['config'] as Map<String, dynamic>),
      processed_images: (json['processed_images'] as List<dynamic>)
          .map((e) => ProcessedImage.fromJson(e as Map<String, dynamic>))
          .toList(),
      paired_images: (json['paired_images'] as List<dynamic>)
          .map((e) => PairedImage.fromJson(e as Map<String, dynamic>))
          .toList(),
      summary: ProcessorSummary.fromJson(
        json['summary'] as Map<String, dynamic>,
      ),
    );

Map<String, dynamic> _$ProcessorReportToJson(ProcessorReport instance) =>
    <String, dynamic>{
...
ProcessorConfig _$ProcessorConfigFromJson(Map<String, dynamic> json) =>
    ProcessorConfig(
      extensions: (json['extensions'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      input_paths: (json['input_paths'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
...
Map<String, dynamic> _$ProcessorConfigToJson(ProcessorConfig instance) =>
    <String, dynamic>{
...
ProcessedImage _$ProcessedImageFromJson(Map<String, dynamic> json) =>
    ProcessedImage(
...
Map<String, dynamic> _$ProcessedImageToJson(ProcessedImage instance) =>
    <String, dynamic>{
...
PairedImage _$PairedImageFromJson(Map<String, dynamic> json) => PairedImage(
  first: json['first'] as String?,
  second: json['second'] as String?,
  output: json['output'] as String?,
);

Map<String, dynamic> _$PairedImageToJson(PairedImage instance) =>
    <String, dynamic>{
