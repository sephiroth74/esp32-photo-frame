...
ConfigProfile _$ConfigProfileFromJson(Map<String, dynamic> json) => ConfigProfile(
...
Map<String, dynamic> _$ConfigProfileToJson(ConfigProfile instance) => <String, dynamic>{
  'name': instance.name,
...
RecentFile _$RecentFileFromJson(Map<String, dynamic> json) =>
    RecentFile(path: json['path'] as String, name: json['name'] as String, lastOpened: DateTime.parse(json['lastOpened'] as String));

Map<String, dynamic> _$RecentFileToJson(RecentFile instance) => <String, dynamic>{
  'path': instance.path,
  'name': instance.name,
...
AppPreferences _$AppPreferencesFromJson(Map<String, dynamic> json) => AppPreferences(
  recentFiles: (json['recentFiles'] as List<dynamic>?)?.map((e) => RecentFile.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
