...
public:
  DisplayDriver6C(int8_t cs_pin, int8_t dc_pin, int8_t rst_pin, int8_t busy_pin, int8_t sck_pin, int8_t mosi_pin);
  ...
  bool has_color() const override { return true; } // 6-color display
