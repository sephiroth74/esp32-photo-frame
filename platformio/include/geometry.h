...
public:
   ...
   */
  inline constexpr bool contains(int16_t px, int16_t py) const { return (px >= x && px < x + width && py >= y && py < y + height); }
  ...
  /**
   * @brief Static factory method to create a rectangle from coordinates and
   * dimensions.
