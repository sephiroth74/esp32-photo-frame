 ...
 */
#define PFR1_MAX_IMAGE_SIZE_FOR(width, height) (PFR1_HEADER_SIZE + ((uint32_t)(width) * (uint32_t)(height)) + PFR1_CRC32_SIZE)

/**
 * Default maximum image size (for 800x480 displays)
 * = 21 + (800 * 480) + 4 = 384,025 bytes
 */
#define PFR1_MAX_IMAGE_SIZE_DEFAULT PFR1_MAX_IMAGE_SIZE_FOR(PFR1_DEFAULT_DISPLAY_WIDTH, PFR1_DEFAULT_DISPLAY_HEIGHT)
