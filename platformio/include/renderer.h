 ...
 * @param refreshStr Optional string to display next to the last update time (default is nullptr).
 * @note This function formats the last update time and displays it on the top left corner of the
 * display. If a refresh string is provided, it will be displayed in parentheses next to the time.
 */
