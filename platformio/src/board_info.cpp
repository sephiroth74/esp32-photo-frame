...
namespace ws {
    ...
    uint32_t BoardInfo::getFlashSize()
    {
    ...
    BoardInfo::DisplaySize BoardInfo::getDisplaySize()
    {
        return DisplaySize { DISP_WIDTH, DISP_HEIGHT };
    }
    ...
    void BoardInfo::clearBatteryInfo()
    {
        s_hasBatteryInfo = false;
    }
