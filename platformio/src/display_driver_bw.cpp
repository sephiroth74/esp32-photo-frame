...
DisplayDriverBW::DisplayDriverBW(int8_t cs_pin, int8_t dc_pin, int8_t rst_pin, int8_t busy_pin, int8_t sck_pin, int8_t mosi_pin)
...
void DisplayDriverBW::sleep() {
  ...
  // Enter deep sleep mode - IMPORTANT: Do not skip this to preserve display
  // lifespan
  EPD_DeepSleep();
