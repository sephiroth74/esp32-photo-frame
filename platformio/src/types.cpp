...
const String getImageSourceString(ImageSource source) {
    switch (source) {
    case IMAGE_SOURCE_CLOUD:       return "Cloud";
    case IMAGE_SOURCE_LOCAL_CACHE: return "Local";
    case IMAGE_SOURCE_BLUETOOTH:   return "Bluetooth";
    case IMAGE_SOURCE_WEBSOCKET:   return "Upload";
...
bool PFR1Header::isValid() const {
    return (magic == PFR1_MAGIC) && (version == 1) && (header_len == PFR1_HEADER_SIZE);
}
